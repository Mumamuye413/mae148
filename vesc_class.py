...
class VESC:
    ...
    '''
    def __init__(self, serial_port, percent=.2, has_sensor=False, start_heartbeat=True, baudrate=115200, timeout=0.05, steering_scale = 1, steering_offset = 0.0 ):
...
# # creates a VESC object with the serial port and also 
# # specify the other keyword arguments if they are 
# # different from the ones in your myconfig.py script
...
# # sample command first argument steering, second argument throttle
# Vesc_object.run(0.10,0.0) 